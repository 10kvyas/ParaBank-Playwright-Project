...
describe('generate-report.js', () => {
    describe('Happy flows', () => {
        ...
        it('should render avif, webp and jpeg embeddings as screenshots (img tags) not as attachments', async () => {
            ...
            const avifFeature = enriched.features.find((f) => f.name === 'AVIF image support');
            const steps = avifFeature.elements[0].steps;
            const avifStep = steps.find((s) => s.name === 'a step with an avif screenshot');
            const webpStep = steps.find((s) => s.name === 'a step with a webp screenshot');
            const jpegStep = steps.find((s) => s.name === 'a step with a jpeg screenshot');
...
//# sourceMappingURL=generate-json.spec.js.map